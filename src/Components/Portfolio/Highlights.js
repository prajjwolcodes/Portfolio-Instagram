...
const Highlights = () => {
    ...
    return (
        <div className="flex justify-center items-center mt-14 w-[90%] overflow-x-auto space-x-4 p-4">
            {highlightsData.map((highlight, index) => (
                <motion.div
                    ...
                    whileTap={{ scale: 0.9 }}
                >
                    <div className="w-16 h-16 sm:w-[86px] sm:h-[86px] rounded-full border-3 border-gray-500 overflow-hidden relative">
                        <img
